    ...
    html += `<div class="column is-one-fifth"><a href="${article.link}">
                    <div class="card">
                        <div class="card-image">
                            ...
                            <img src="${img}" style="object-fit: cover;" alt="News" onerror="this.style.display='none'">
                            </figure>
                        </div>
                ...
                show(article.link, article.publisher, article.title);
  }
